...
This builder uses the [Paketo Ubuntu Resolute base images](https://github.com/paketo-buildpacks/ubuntu-resolute-base-images) with buildpacks for Java, Node.js, .NET, and Procfile.
